...
public class TestData {
    /**
     * Package-private access -- only tests within src/test/java
     * Arrays that do not use initializer have all elements assigned to 0 by default.
     * 0 represents an empty square in the sudoku puzzle.
